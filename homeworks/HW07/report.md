...
### 1.1 Датасет A: S07-hw-dataset-02.csv
...
### 1.2 Датасет B: S07-hw-dataset-03.csv
...
### 1.3 Датасет C: S07-hw-dataset-04.csv
...
### 4.1 Датасет 02: Нелинейная структура + выбросы
...
### 4.2 Датасет 03: Кластеры с различной плотностью
...
### 4.3 Датасет 04: Высокая размерность + смешанные типы
...
### 5.1 Сравнение алгоритмов – ключевые наблюдения
...
### 5.2 Анализ устойчивости – Датасет 02
